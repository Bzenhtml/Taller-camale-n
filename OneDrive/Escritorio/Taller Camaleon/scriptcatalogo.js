...
document.getElementById("AplicarFiltroId").addEventListener("click", function(){ /*Aqui se aplican los filtros que se pongan: Precio minimo, maximo y el tipo de producto, ademas de que se reorganiza*/
